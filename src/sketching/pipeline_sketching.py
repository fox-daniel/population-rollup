...
# pipeline_funcs.print_select_columns(select_cols, cols, cols_inds)

# num_rows = pipeline_funcs.count_rows()
# print(num_rows)

# pipeline_funcs.write_col_keys(cols)

# pipeline_funcs.print_select_cols_and_rows(select_cols, cols, cols_inds, 51, 500)

# pipeline_funcs.print_select_cols_from_rows_with_X(select_cols, cols, cols_inds)
...
# pipeline_funcs.write_error_rows(path_to_errors_csv, error_rows)
